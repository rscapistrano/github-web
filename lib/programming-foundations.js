 ...
 * - Weak typing
 * - creates interactivity: click, drag, tap, swipe, etc.
 * - commonly used for front-end development
 * - increasingly for front- and back-end development
 *
 * Don't Use JavaScript for:
 * - CSS: hover over, focus events, styling, image swaps, rollover menus
 * - CSS3: transitins instead of JS animation
 * - HTML5 form controls instead of custom widgets (important on mobile platforms)
 *
 *
 * JavaScript Jargon
 *
 * Data Type
 * - numbers, strings, booleans, arrays, objects (built-in: window, document, and more; objects have properties)
 * - variables - nouns
 * - operators - verbs
 * - functions - paragraphs (also a data type of their own right); inside an object - a method
 * - arguments - how we get data into a function for processing
 * - control structures - logical operations; if, else, switch
 * - loops - for, while
 * 
 *
 * Operators with =
 ...
 * - the methods available for manipulating the goods
 * - built-in methods: document.getElementByID
 * - properties: value, checked, className, id
 * 
 *
 ...
 *
 * Management
 * - Manual for lower level languages
 * - Reference counting
 * - Garbage collection (Java, C#, etc.)
 * - Automatic for higher level languages
 * 
 */
 ...
 *
 * Challenges
 * - competition for resources (example, competiting threads trying to save to the same file)
...
/**
 * Different Languages Overview
 *
 * Java Characteristics
 * - Object-oriented; large library
 * - high-level; strongly typed, garbage collected
 * - hybrid compilation; partially interpreted language so you need the interpreter (java virtual machine, jvm) in your machine
 * - intermediate byte code
 *
 * Java - What's it used for?
 ...
 *
 *
 * C# and VB.NET Characteristic
 * - object-oriented; large library
 * - high-level; strongly typed, garbage collected
 * - compiled to intermediate language; required .net runtime to be installed in the machine
 *
 * C# and VB.NET - What's it used for?
 * - wondows desktop apps
 * - web apps: 'ASP.NET'
 ...
 * Ruby Characteristic
 * - object-oriented
 * - high-level; interpreted; garbage collected
 * - beginner/intermediate
 *
 * Ruby - What's it used for?
 * - cross-platform
 * - web apps: Ruby on Rails - web framework
 * - writing small utilities
 *
 * 
 * Python Characteristic
 * - object-oriented; large library
 * - high-level; interpreted; garbage collected; strongly typed
 * - beginner/intermediate
 * 
 * Python - What's it used for?
 * - cross-platform
 * - web apps
 * - embedded sripting language
 *
 *
 * 
 */
